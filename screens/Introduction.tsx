        ...
        >
            ...
            >
                ...
                <Text style={styles.contentText}>
                    Our UI library provides a collection of beautifully animated components that are easy to use and highly
                    customizable. Built on top of Moti and Reanimated, it offers a simple API for creating complex animations with
                    minimal code.
                </Text>
                    ...
                    <MotiView from={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ type: "timing", duration: 300 }}>
                        ...
                        <View style={styles.infoCard}>
                            ...
                            <Text style={styles.infoText}>
                                Expo is a framework and platform for universal React applications. It's a set of tools and services
                                built around React Native that help you develop, build, deploy, and quickly iterate on iOS, Android, and
                                web apps.
                            </Text>
                        </View>
                    </MotiView>
            ...
            >
                <View style={styles.nextStepsCard}>
                    ...
                    <Text style={styles.nextStepsText}>
                        Now that you understand the basics of our UI library, the next step is to set up the required dependencies.
                        Head to the Installation page to learn how to install React Native Reanimated, Gesture Handler, React Native
                        Skia, and Moti in your project.
                    </Text>
                    <Pressable
