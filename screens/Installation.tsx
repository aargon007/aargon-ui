        ...
        >
            ...
            >
                ...
                <Text style={styles.contentText}>
                    Follow these steps to install and configure the required libraries for your React Native UI project. Each
                    library serves a specific purpose in creating fluid, interactive animations and UI components.
                </Text>
                ...
                <View style={styles.installMethodToggle}>
                    ...
                    >
                        <Text style={[styles.methodButtonText, installMethod === "npm" && styles.methodButtonTextActive]}>
                            npm
                        </Text>
                    </Pressable>
                    ...
                    >
                        <Text style={[styles.methodButtonText, installMethod === "yarn" && styles.methodButtonTextActive]}>
                            yarn
                        </Text>
                    </Pressable>
                </View>
                ...
                <View style={styles.nextStepsCard}>
                    ...
                    <Text style={styles.nextStepsText}>
                        After installing these libraries, you're ready to start building beautiful, animated UI components. Check
                        out the Components and Examples sections to see how to use these libraries together.
                    </Text>
