            ...
            {libraries.map((library, index) => (
                <MotiView
                    ...
                    <Pressable
                        ...
                        <Feather name={expandedLibrary === library.id ? 'chevron-up' : 'chevron-down'} size={20} color="#6B7280" />
                    </Pressable>
                        ...
                        <MotiView
                            ...
                            <View style={styles.installCommand}>
                                <Text style={styles.installCommandText}>
                                    {installMethod === 'npm' ? library.npm : installMethod === 'expo' ? library.expo : library.yarn}
                                </Text>
                            ...
                            {library.extraSteps.length > 0 && (
                                <View style={styles.extraSteps}>
                                    <Text style={styles.extraStepsTitle}>Additional Setup</Text>
